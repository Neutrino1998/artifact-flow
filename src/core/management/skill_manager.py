"""SkillManager —— skill 列举/toggle 与导入/导出/删除用例编排。
...
from core.capabilities.effective_skillset import EffectiveSkillSet, resolve_effective_skillset
...
class SkillManager:
    ...
    async def update_admin_shared(
        ...
        *,
        ...
        await self._repo.commit_changes()
