...
from core.execution.events import ExecutionEvent, StreamEventType, TERMINAL_EVENT_TYPES
...
def ensure_terminal(pp: PostProcessState) -> None:
    ...
    terminal_types = TERMINAL_EVENT_TYPES  # 权威集合(core.execution.events),含 TIMED_OUT
