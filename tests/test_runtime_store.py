...
# with CompactionManager — they were only consumed by the old distributed-lock
# compaction path. Conversation lease (try_acquire_lease / renew_lease /
# release_lease) is tested separately.
