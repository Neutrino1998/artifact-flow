---
# Disabled for intranet by filename prefix. Loader skips `_*.md` files.
# Re-enable only after intranet egress/search routing is explicitly restored.
name: research_agent
description: |
...
tools:
  ...
  # Intranet default keeps public web tools disabled.
  # web_search: enabled
  # web_fetch: enabled
