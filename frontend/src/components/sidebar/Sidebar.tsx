    ...
    <div className="flex flex-col h-full bg-panel dark:bg-panel-dark">
      ...
      <div className="px-3 pt-3 pb-3 space-y-2">
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 text-sm text-action-contrast dark:text-text-primary-dark bg-action dark:bg-bg-dark border border-action/25 dark:border-border-dark rounded-card hover:bg-action-hover dark:hover:bg-surface-dark transition-colors"
        >
