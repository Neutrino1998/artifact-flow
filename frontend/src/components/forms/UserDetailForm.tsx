  ...
  if (loadError || !user) {
    return (
      <div className="flex-1 flex flex-col gap-3 items-center justify-center bg-chat dark:bg-chat-dark p-6">
        ...
        <button
          onClick={loadUser}
          className="px-4 py-1.5 rounded-lg border border-border dark:border-border-dark text-text-secondary dark:text-text-secondary-dark font-medium hover:bg-bg dark:hover:bg-bg-dark transition-colors"
        >
          重试
        </button>
      </div>
